...
if __name__ == "__main__":
    ...
    es = Elasticsearch(hosts="http://localhost:9200", verify_certs=False, http_auth=(http_user, http_password))
    ...
    def search(text):
        try:
            ...
            result = {hit["_id"]: hit["_score"] for hit in response["hits"]["hits"]}
            return result
